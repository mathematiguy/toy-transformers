...
all: pytorch_model.bin

pytorch_model.bin: spanbert_hf_base.tar.gz
	tar -xzvf spanbert_hf_base.tar.gz

spanbert_hf_base.tar.gz:
	wget https://dl.fbaipublicfiles.com/fairseq/models/spanbert_hf_base.tar.gz && touch $@
